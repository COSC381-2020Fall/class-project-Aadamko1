...
def handle_query_view():
    ...
    results_cnt = query_results[1] #returns a total number of the search results
...
def handle_request():
    ...
    server.starttls()
    server.login("akowski08@gmail.com", config.gmail_password)
    message = 'Subject: {}\n\n{}'.format("Request to add new data", "request to add: " + new_data)
    server.sendmail("akowski08@gmail.com", "aadamko1@emich.edu", message)
